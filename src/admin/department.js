...
delete_department = (id) => {
    fetch(`http://localhost:8080/departments/${id}`, {
        ...
        .then(response => {
            if (response.ok) {
                alert("Xoa phong ban thanh cong")
                show_all_departments()
            }
        })
...
edit_department = (id) => {
    ...
    console.log("Thong tin cap nhat phong ban: ", new_department_data)
    ...
    fetch(`http://localhost:8080/departments/${id}`, {
        ...
        .then(response => {
            if (response.ok) {
                alert("Cap nhat thong tin phong ban thanh cong");
                show_all_departments()
            }
        })
...
add_new_department = () => {
    ...
    console.log("Thong tin phong ban moi: ", new_department_data)
    ...
    fetch("http://localhost:8080/departments", {
        ...
        .then(response => {
            if (response.ok) {
                alert("Them phong ban thanh cong")
                show_all_departments()
            }
        })
        .catch(err => console.log("Gap loi: ", err))
