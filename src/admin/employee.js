            ...
            data.forEach(element => {
                employee_tbody.innerHTML +=
                    `   <tr id="tr_${element.id}">
                        ...
                        <td>
                            <button type="button" onclick='delete_employee("${element.id}")'>Xóa</button>
                            <button type="button" onclick='pre_edit_employee("${element.id}")'>Chỉnh sửa</button>
                        </td>
                    </tr>`
            })
        })
...
pre_edit_employee = (id) => {
    ...
    selected_employee_info = employeeData.find(item => item.id === `${id}`)
    ...
    selected_employee.innerHTML =
        ...
        <td>
            <button type="button" onclick='cancle_edit_employee()'>Hủy</button>
